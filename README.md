...
現在の入力では使えない文献ルールについても、追加でどの評価項目を取得すれば活用できるかを結果画面で案内します。
...
#### B. 追加評価の提案
- **今の時点で追加取得すると活用できる文献**: 追加評価で参照可能になるルール
- **時期条件のため今回は活用できない文献**: 評価を追加しても時期条件により適用できないルール
- **表示内容**: 足りない評価項目、入力箇所、活用できる予測アウトカム
